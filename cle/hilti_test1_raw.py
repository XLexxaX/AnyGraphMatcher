...
from cle.matcher import EmbeddingMatcher, StableRankEmbeddingsMatcher, PredictionToXMLConverter
...
def main():
    ...
    name = "OAEI_emb_d2v_batch_walklength1"
    pipeline = Pipeline()
    ...
    line_ab = pipeline.append_step(StableRankEmbeddingsMatcher.interface, PipelineDataTuple(line_ab), None)
...
#
    ...
    name = "OAEI_emb_relw2v_steps_walklength1"
    pipeline = Pipeline()
    line_a = pipeline.append_step(load_kg_with_rdflib_ttl_interface, None, PipelineDataTuple(src_triples))
    line_a = pipeline.append_step(GraphToolbox.interface, PipelineDataTuple(line_a), PipelineDataTuple(src_triples))
    line_b = pipeline.append_step(load_kg_with_rdflib_ttl_interface, None, PipelineDataTuple(tgt_triples))
    ...
    #name = "OAEI_emb_relw2v_batch_walklength1"
    #pipeline = Pipeline()
    #line_a = pipeline.append_step(load_kg_with_rdflib_ttl_interface, None, PipelineDataTuple(src_triples))
    #line_a = pipeline.append_step(GraphToolbox.interface, PipelineDataTuple(line_a), PipelineDataTuple(src_triples))
    #line_b = pipeline.append_step(load_kg_with_rdflib_ttl_interface, None, PipelineDataTuple(tgt_triples))
...
#
#
    #name = "OAEI_emb_relw2v_steps_walklength3"
    #pipeline = Pipeline()
    #line_a = pipeline.append_step(load_kg_with_rdflib_ttl_interface, None, PipelineDataTuple(src_triples))
    #line_a = pipeline.append_step(GraphToolbox.interface, PipelineDataTuple(line_a), PipelineDataTuple(src_triples))
    #line_b = pipeline.append_step(load_kg_with_rdflib_ttl_interface, None, PipelineDataTuple(tgt_triples))
