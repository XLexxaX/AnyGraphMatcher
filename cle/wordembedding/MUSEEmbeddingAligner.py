...
#
import sys
sys.path.insert(0, 'cle/crosslingual/muse/MUSE/')
import os
import json
import argparse
...
from cle.crosslingual.muse.MUSE.src.utils import bool_flag, initialize_exp
from cle.crosslingual.muse.MUSE.src.models import build_model
from cle.crosslingual.muse.MUSE.src.trainer import Trainer
from cle.crosslingual.muse.MUSE.src.evaluation import Evaluator
...
def align(src_emb, tgt_emb, src_lang, tgt_lang, emb_dim, dico_train):
    ...
    parser.add_argument("--emb_dim", type=int, default=emb_dim, help="Embedding dimension")
    parser.add_argument("--max_vocab", type=int, default=200000, help="Maximum vocabulary size (-1 to disable)")
    # training refinement
    parser.add_argument("--n_refinement", type=int, default=5, help="Number of refinement iterations (0 to disable the refinement procedure)")
    # dictionary creation parameters (for refinement)
    parser.add_argument("--dico_train", type=str, default=dico_train, help="Path to training dictionary (default: use identical character strings)")
    parser.add_argument("--dico_eval", type=str, default=dico_train, help="Path to evaluation dictionary")
    ...
    parser.add_argument("--src_emb", type=str, default=src_emb, help="Reload source embeddings")
    parser.add_argument("--tgt_emb", type=str, default=tgt_emb, help="Reload target embeddings")
