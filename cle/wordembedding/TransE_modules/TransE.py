...
from wordembedding.TransE_modules.load_pretrained import load


class TransE(nn.Module):

    def __init__(self, numOfEntity, numOfRelation, entityDimension, relationDimension, margin, norm, rundir):
