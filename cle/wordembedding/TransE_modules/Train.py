...
from wordembedding.TransE_modules.TransE import TransE
from wordembedding.TransE_modules.readTrainingData import readData
from wordembedding.TransE_modules.generatePosAndCorBatch import generateBatches, dataset
...
class trainTransE:
    ...
    def train(self, rundir):
        ...
        for epoch in range(self.numOfEpochs):
            ...
            if True:# tmpAvFiMR < self.bestAvFiMR:
