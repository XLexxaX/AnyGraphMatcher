...
from cle.matcher import PredictionToXMLConverter
...
def exec(graph1, graph2):
        ...
        cols = [col for col in oaei_gold_standard3.columns if col not in ['label','src_id','tgt_id','syntactic_diff','plus_diff','src_category','tgt_category']]#['src_tgt_angle', 'src_tgt_veclen', 'plus_diff', 'syntactic_diff']
