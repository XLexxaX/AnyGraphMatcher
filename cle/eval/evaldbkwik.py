...
from cle.loadkg.kg import KG, KGInMemory
from cle.loadkg.loadFromTargz import load_kg_from_targz_dbkwik_files, load_kg_from_targz_dbkwik_files_in_memory
from cle.loadkg.loadFromXml import load_kg_from_xml
from cle.eval.rankingeval import RankingEvaluation
from cle.eval.confusionmatrix import confusionmatrix
from cle.eval.alignmentformat import parse_mapping_from_file
from cle.eval.rankingeval import create_hits_at_k
...
if __name__ == '__main__':
    ...
    #print([i * 100 for i in eval_class])
    #print("{:3.2f}->{:3.2f}".format(*[0.25, 0.5454545454545454]))
    logger.info("{:^41} | {:^41} | {:^41}".format("Classes", "Properties", "Instances"))
