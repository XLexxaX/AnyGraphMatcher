...
from cle.eval.evaldbkwik import evaluate
from cle.sentencegenerator.randomwalks import generate_random_walks
from cle.sentencegenerator.literalwalks import generate_literal_walks
from cle.wordembedding.word2vec import word2vec_embedding_from_sentences, word2vec_embedding_from_kg
from cle.matcher.linearprojectionmatcher import LinearProjectionMatcher
from cle.matcher.analysematcher import AnalyseMatcher
from cle.matcher.sharedembeddingmatcher import SharedEmbeddingMatcher
from cle.matcher.simpleliteral import SimpleLiteralMatcher
from cle.matcher.randtransmatcher import RandomTranslationMatcher
from cle.crosslingual.linearprojection import linear_projection# ,sgd_projection, orth_projection
from cle.matcher.ccamatcher import CCAMatcher
from cle.kgembedding.docembedding import doc2vec_embedding, doc2vec_embedding_from_kg
...
if __name__ == '__main__':
    ...
    # from cle.wordembedding.lsa import lsa_embedding_from_sentences
    #
